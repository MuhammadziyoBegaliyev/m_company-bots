...
L = {
    "uz": {
        ...
        "prj_iservice_body": "Servis kompaniyalariga mos CRM va ichki jarayonlar boshqaruvi.",
        ...
        "btn_audit": "Audit xizmat / Bron",
        "audit_title": "Audit xizmat / Bron",
        "audit_choose": "Kerakli bo‘limni tanlang:",
        "audit_btn_site": "🌐 Website",
        "audit_btn_book": "🗓️ Bron qilish",
    ...
    "en": {
        ...
        "btn_audit": "Audit / Booking",
        "audit_title": "Audit / Booking",
        "audit_choose": "Choose an option:",
        "audit_btn_site": "🌐 Website",
        "audit_btn_book": "🗓️ Book a slot",
        "audit_site_text": "A short overview of our audit service.",
        "audit_more_btn": "Learn more",
    ...
    "ru": {
        ...
        "btn_audit": "Аудит / Бронь","btn_audit": "Аудит / Бронь",
        "audit_title": "Аудит / Бронь",
        "audit_choose": "Выберите раздел:",
        "audit_btn_site": "🌐 Веб-сайт",
        "audit_btn_book": "🗓️ Забронировать",
        "audit_site_text": "Кратко об услуге аудита.",
        "audit_more_btn": "Подробнее",
    },
}
